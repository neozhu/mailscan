...
public static class DepartmentCacheKey
{
    ...
    public static string GetPaginationCacheKey(string parameters) {
        return $"DepartmentCacheKey:DepartmentsWithPaginationQuery,{parameters}";
    }
    public static string GetByNameCacheKey(string parameters) {
        return $"DepartmentCacheKey:GetByNameCacheKey,{parameters}";
    }
    public static string GetByIdCacheKey(string parameters) {
        return $"DepartmentCacheKey:GetByIdCacheKey,{parameters}";
    }
